  ...
  const emergencies = [
    {
      ...
      content: [
        "<h4>Atendimento Pré-Hospitalar (SBV - Suporte Básico de Vida)</h4>",
        "<ul>",
        ...
        "</ul>",
        "<hr class='my-4'/>",
        "<h4>Atendimento Intra-Hospitalar (SAVC - Suporte Avançado de Vida)</h4>",
        "<ul>",
        ...
        "</ul>",
        "<hr class='my-4'/>",
        "<h4>Causas Reversíveis (5 Hs e 5 Ts)</h4>",
        "<ul>",
