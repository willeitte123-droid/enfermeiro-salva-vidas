  ...
  const emergencies = [
    {
      ...
      content: [
        ...
        "<strong>5. Inicie RCP de Alta Qualidade:</strong> Se não houver pulso ou respiração, inicie ciclos de <Badge variant='destructive'>30 compressões : 2 ventilações</Badge>.<ul class='pl-5 mt-2 space-y-1 list-disc'><li>Frequência: <Badge>100-120/min</Badge></li><li>Profundidade: <Badge>5-6 cm</Badge></li><li>Permita o retorno completo do tórax.</li><li>Minimize as interrupções.</li></ul>",
        ...
        "<ul class='pl-5 space-y-1 list-disc'><li><strong>5 Hs:</strong> Hipovolemia, Hipóxia, Hidrogênio (acidose), Hipo/Hipercalemia, Hipotermia.</li><li><strong>5 Ts:</strong> Tensão no tórax (pneumotórax), Tamponamento cardíaco, Toxinas, Trombose pulmonar, Trombose coronariana.</li></ul>"
      ]
    },
    {
