  ...
  const emergencies = [
    {
      ...
      content: [
        ...
        "<strong>1. Segurança do Local:</strong> Garanta que a cena é segura para você e para a vítima.",
        "<strong>2. Responsividade:</strong> Chame e toque nos ombros da vítima. 'Senhor, senhor, está me ouvindo?'.",
        "<strong>3. Acione Ajuda:</strong> Peça para alguém ligar para o serviço de emergência (192) e trazer um DEA.",
        "<strong>4. Cheque Pulso e Respiração:</strong> Verifique o pulso carotídeo e a respiração simultaneamente por 5-10 segundos.",
        "<strong>5. Inicie RCP de Alta Qualidade:</strong> Se não houver pulso ou respiração, inicie ciclos de <Badge variant='destructive'>30 compressões : 2 ventilações</Badge>.<ul><li>Frequência: <Badge>100-120/min</Badge></li><li>Profundidade: <Badge>5-6 cm</Badge></li><li>Permita o retorno completo do tórax.</li><li>Minimize as interrupções.</li></ul>",
        "<strong>6. Use o DEA:</strong> Assim que o DEA chegar, ligue-o e siga as instruções. Aplique as pás e afaste-se para análise e choque, se indicado. Reinicie a RCP imediatamente após o choque.",
        "<hr class='my-4'/>",
        ...
        "<strong>H</strong>ipovolemia, <strong>H</strong>ipóxia, <strong>H</strong>idrogênio (acidose), <strong>H</strong>ipo/<strong>H</strong>ipercalemia, <strong>H</strong>ipotermia.",
        "<strong>T</strong>ensão no tórax (pneumotórax), <strong>T</strong>amponamento cardíaco, <strong>T</strong>oxinas, <strong>T</strong>rombose pulmonar, <strong>T</strong>rombose coronariana."
      ]
    },
    {
