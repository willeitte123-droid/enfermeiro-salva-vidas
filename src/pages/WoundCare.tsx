...
const dressingTypes = [
    { name: "Hidrocoloide", indication: "Feridas limpas com exsudato leve a moderado, áreas de pressão, prevenção de LPP.", action: "Forma um gel que mantém o ambiente úmido, promove desbridamento autolítico e protege a ferida.", contraindication: "Não usar em feridas infectadas, com exposição óssea/tendínea, queimaduras de 3º grau ou em pacientes com pele muito frágil." },
    { name: "Hidrogel", indication: "Feridas secas, com necrose ou esfacelo. Queimaduras de 1º e 2º grau. Alívio da dor.", action: "Hidrata o leito da ferida, amolece tecidos desvitalizados, facilitando o desbridamento autolítico.", contraindication: "Não indicado para feridas com alto exsudato (risco de maceração). Requer cobertura secundária." },
    { name: "Alginato de Cálcio", indication: "Feridas com exsudato moderado a alto, cavitárias, sangrantes e infectadas (versão com prata).", action: "Derivado de algas marinhas, alta capacidade de absorção, forma um gel ao contato com o exsudato. Possui ação hemostática.", contraindication: "Não usar em feridas secas ou com necrose dura. Requer cobertura secundária." },
    { name: "Hidrofibra (com ou sem prata)", indication: "Feridas com exsudato moderado a alto, incluindo feridas cavitárias.", action: "Tecnologia de gelificação vertical. Absorve o exsudato e o transforma em um gel coeso, minimizando a maceração da pele perilesional.", contraindication: "Não usar em feridas secas. Requer cobertura secundária." },
    { name: "Espuma de Poliuretano", indication: "Feridas com exsudato moderado a alto, proteção de proeminências ósseas, terapia compressiva.", action: "Absorvente, mantém o leito úmido, protege contra impacto e é termicamente isolante. Pode ter borda de silicone.", contraindication: "Não indicada para feridas secas ou com pouquíssimo exsudato." },
    { name: "Carvão Ativado com Prata", indication: "Feridas infectadas, com odor fétido e exsudativas.", action: "Controla o odor (carvão) e a infecção (prata). Absorve o exsudato e as bactérias.", contraindication: "Hipersensibilidade à prata. Não cortar a cobertura. Requer cobertura secundária." },
    { name: "Coberturas com Prata", indication: "Feridas com infecção ou alto risco de infecção (colonização crítica).", action: "A prata tem ação antimicrobiana de amplo espectro. Disponível em espumas, alginatos, hidrofibras, etc.", contraindication: "Hipersensibilidade. Uso por tempo limitado (geralmente até 14 dias) para evitar toxicidade e resistência." },
    { name: "PHMB (Polihexanida)", indication: "Limpeza de feridas, tratamento de feridas colonizadas, infectadas ou com biofilme.", action: "Antisséptico de amplo espectro com baixa toxicidade celular. Eficaz contra biofilme.", contraindication: "Hipersensibilidade. Não usar em cartilagem hialina, cérebro ou meninges." },
    { name: "Colagenase", indication: "Desbridamento enzimático de tecido necrótico ou esfacelo.", action: "Enzima que degrada seletivamente o colágeno desvitalizado, preservando o tecido de granulação.", contraindication: "Não usar com produtos que contenham prata, iodo ou metais pesados (inativam a enzima). Requer umidade para agir." },
    { name: "Papaína", indication: "Desbridamento químico/enzimático de tecido necrótico e esfacelo.", action: "Enzima proteolítica que degrada tecido desvitalizado. A concentração varia conforme o tipo de tecido (ex: 2-4% para esfacelo, 6-10% para necrose).", contraindication: "Não usar em tecido de granulação. Inativada por metais pesados. Requer prescrição e preparo cuidadoso." },
    { name: "AGE (Ácidos Graxos Essenciais)", indication: "Prevenção de lesões por pressão, hidratação de pele, feridas em fase de epitelização.", action: "Promove quimiotaxia, angiogênese e mantém o meio úmido. Melhora a elasticidade da pele.", contraindication: "Não usar em feridas muito exsudativas ou infectadas. Não é um desbridante." },
    { name: "Filme Transparente", indication: "Fixação de cateteres, proteção de pele íntegra, cobertura de feridas superficiais sem exsudato (ex: Estágio 1 de LPP).", action: "Barreira semipermeável (permite trocas gasosas) contra água e bactérias, permite a visualização do local.", contraindication: "Não usar em feridas exsudativas, infectadas ou em pele frágil." },
    { name: "Gaze Não Aderente (Rayon)", indication: "Feridas limpas com baixo exsudato, queimaduras, áreas doadoras de enxerto.", action: "Interface que previne a aderência do curativo secundário ao leito da ferida, protegendo o tecido novo.", contraindication: "Não é absorvente. Não deve ser usada sozinha em feridas exsudativas." },
    { name: "Curativos de Silicone", indication: "Pele frágil e sensível, prevenção de lesões por fricção, feridas em fase de epitelização, tratamento de cicatrizes hipertróficas.", action: "Adesivo suave que minimiza a dor e o trauma na troca do curativo. Pode ser reposicionado.", contraindication: "Não indicado para feridas com alto exsudato ou infecção." },
    { name: "Mel Medicinal", indication: "Feridas agudas e crônicas, colonizadas ou infectadas, com odor.", action: "Ação antimicrobiana de amplo espectro, anti-inflamatória, promove desbridamento autolítico e controla o odor.", contraindication: "Hipersensibilidade ao mel. Usar apenas produtos de grau médico, esterilizados." },
    { name: "Bota de Unna", indication: "Úlceras venosas em membros inferiores, sem infecção.", action: "Bandagem compressiva inelástica impregnada com óxido de zinco que melhora o retorno venoso e promove a cicatrização.", contraindication: "Insuficiência arterial (ITB < 0.8), infecção ativa, ICC descompensada." },
    { name: "Terapia por Pressão Negativa (TPN)", indication: "Feridas complexas, agudas ou crônicas, com alto exsudato, enxertos de pele.", action: "Aplica pressão subatmosférica controlada, remove exsudato, reduz edema, estimula a granulação e aproxima as bordas.", contraindication: "Necrose não desbridada, malignidade na ferida, fístulas não exploradas, osteomielite não tratada." }
];
