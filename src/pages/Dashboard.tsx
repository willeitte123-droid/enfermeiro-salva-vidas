            ...
            {quickAccessLinks.map((link) => {
              ...
              return (
                <Link to={link.path} key={link.title}>
                  <Card className={cn("h-full bg-gray-900 text-white hover:bg-gray-800 dark:bg-gray-950 dark:hover:bg-gray-900 transition-all group border-2 border-transparent", link.colorClasses.hoverBorder)}>
