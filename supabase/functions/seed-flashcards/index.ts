...
const FLASHCARDS_DATA = [
  ...
  // --- NOVOS FLASHCARDS: IMUNIZAÇÃO (PNI) ---
  { deck_category: 'Imunização (PNI)', front_content: 'Qual a faixa de temperatura ideal para conservação da maioria das vacinas na geladeira da sala de vacina?', back_content: 'Entre +2°C e +8°C, com temperatura ideal de +5°C.' },
  { deck_category: 'Imunização (PNI)', front_content: 'Onde as vacinas devem ser armazenadas na geladeira? E onde NUNCA devem ser armazenadas?', back_content: 'Na primeira e segunda prateleiras. NUNCA na porta, no congelador ou nas gavetas inferiores.' },
  { deck_category: 'Imunização (PNI)', front_content: 'Qual termômetro é usado para verificar a temperatura máxima e mínima da geladeira e quando deve ser lido?', back_content: 'Termômetro de máxima e mínima. A leitura deve ser feita no início e no final do dia de trabalho.' },
  { deck_category: 'Imunização (PNI)', front_content: 'O que é um Evento Adverso Pós-Vacinação (EAPV) grave?', back_content: 'Qualquer evento que resulte em hospitalização, risco de vida, incapacidade permanente ou óbito. Ex: Choque anafilático, convulsão.' },
  { deck_category: 'Imunização (PNI)', front_content: 'Qual a principal diferença entre vacinas de vírus vivo atenuado e vacinas inativadas?', back_content: 'Atenuadas (ex: Tríplice Viral, BCG) contêm o agente enfraquecido. Inativadas (ex: VIP, Influenza, dT) contêm o agente morto ou partículas dele.' },
  { deck_category: 'Imunização (PNI)', front_content: 'Qual a principal contraindicação para vacinas de vírus vivo atenuado?', back_content: 'Gestantes e pessoas com imunodeficiência grave (congênita ou adquirida).' },
  { deck_category: 'Imunização (PNI)', front_content: 'Qual a evolução normal da lesão da vacina BCG?', back_content: 'Mácula -> Pápula -> Pústula -> Úlcera -> Crosta -> Cicatriz. Dura de 6 a 12 semanas.' },
  { deck_category: 'Imunização (PNI)', front_content: 'Crianças que não desenvolveram a cicatriz da BCG devem ser revacinadas?', back_content: 'Não. A ausência de cicatriz não significa ausência de proteção. A revacinação não é mais recomendada pelo PNI.' },
  { deck_category: 'Imunização (PNI)', front_content: 'Qual a idade máxima para iniciar (1ª dose) e para completar (2ª dose) o esquema da vacina Rotavírus?', back_content: '1ª dose: até 3 meses e 15 dias. 2ª dose: até 7 meses e 29 dias.' },
  { deck_category: 'Imunização (PNI)', front_content: 'Em campanhas, a dose fracionada da vacina Febre Amarela confere proteção por quanto tempo?', back_content: 'Pelo menos 8 anos. A dose padrão confere proteção por toda a vida.' },
  { deck_category: 'Imunização (PNI)', front_content: 'Qual o esquema vacinal padrão para Hepatite B em recém-nascidos?', back_content: '4 doses: ao nascer, aos 2, 4 e 6 meses (esta última como parte da vacina Pentavalente).' },
  { deck_category: 'Imunização (PNI)', front_content: 'Em que idades a criança recebe os reforços da vacina DTP (Tríplice Bacteriana)?', back_content: 'Aos 15 meses (1º reforço) e aos 4 anos (2º reforço).' },
  { deck_category: 'Imunização (PNI)', front_content: 'Como é o esquema da vacina Meningocócica C no primeiro ano de vida?', back_content: 'Duas doses, aos 3 e 5 meses de idade, com um reforço aos 12 meses.' },
  { deck_category: 'Imunização (PNI)', front_content: 'Qual a diferença entre a vacina Pneumocócica 10-valente (VPC10) e a 23-valente (VPP23)?', back_content: 'VPC10 (conjugada) é usada no calendário infantil. VPP23 (polissacarídica) é usada para idosos e grupos de risco, cobrindo mais sorotipos.' },
  { deck_category: 'Imunização (PNI)', front_content: 'Em que idade a vacina contra Varicela é administrada no calendário básico?', back_content: 'Aos 15 meses, como parte da vacina Tetra Viral (Sarampo, Caxumba, Rubéola e Varicela).' },
  { deck_category: 'Imunização (PNI)', front_content: 'Qual o evento adverso mais comum da vacina BCG?', back_content: 'Úlcera com diâmetro maior que 1 cm ou linfadenopatia regional supurada.' },
  { deck_category: 'Imunização (PNI)', front_content: 'Quais vacinas NÃO podem ser congeladas sob nenhuma hipótese?', back_content: 'Todas as vacinas que contêm adjuvante de alumínio (ex: Penta, DTP, dT, Hepatite B, HPV). O congelamento inativa a vacina.' },
  { deck_category: 'Imunização (PNI)', front_content: 'Vacinas de vírus vivo atenuado podem ser administradas no mesmo dia?', back_content: 'Sim. Se não forem administradas no mesmo dia, deve-se respeitar um intervalo mínimo de 30 dias entre elas.' },
  { deck_category: 'Imunização (PNI)', front_content: 'O que significa a sigla CRIE e qual sua função?', back_content: 'Centro de Referência para Imunobiológicos Especiais. Oferece vacinas para pessoas com condições clínicas especiais.' },
  { deck_category: 'Imunização (PNI)', front_content: 'Qual a idade para administração da vacina contra Hepatite A?', back_content: 'Aos 15 meses de idade, em dose única.' },
